                ...
                <AnimatePresence mode="wait">
                    {isVisible ? (
                        ...
                        >
                            ...
                            <div className="relative h-[27rem] mb-8 overflow-hidden">
                                <AnimatePresence mode="wait" initial={false}>
                                    ...
                                    >
                                        ...
                                        <motion.div
                                            ...
                                            className={`relative w-36 h-36 rounded-3xl bg-gradient-to-br ${currentFact.bgGradient} flex items-center justify-center mb-7 shadow-lg`}
                                        >
                                            <IconComponent className="text-white" size={72} strokeWidth={2} />
                                            ...
                                            <motion.div
                                                ...
                                                className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${currentFact.bgGradient}`}
                                            />
                                        </motion.div>
                                        ...
                                        >
                                            <span className={`inline-block px-7 py-3 bg-gradient-to-r ${currentFact.bgGradient} text-white text-xl font-bold rounded-full shadow-md`}>
                                                {currentFact.metric}
                                            </span>
                                        </motion.div>
                                        ...
                                        <motion.p
                                            ...
                                            className="text-lg text-slate-600 leading-relaxed text-center px-4"
                                        >
