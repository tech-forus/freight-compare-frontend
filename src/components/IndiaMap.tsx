...
// =============================================================================
// Map Constants - This component uses a larger viewBox for the simplified outline
// =============================================================================
const MAP_VIEWBOX = {
  width: 1000,
  height: 1118,
 ...
 * Uses the same projection formula as NetworkCoverageMap but scaled to this viewBox.
 */
const convertLatLngToSvgPoint = (coords: LatLng): { x: number; y: number } => {
  return latLngToSvg(coords.lat, coords.lng, MAP_VIEWBOX, INDIA_GEO_BOUNDS);
};
...
export const IndiaMap: React.FC<IndiaMapProps> = ({ originCoords, destCoords }) => {
  ...
  return (
    ...
    >
      ...
      {/* Base Map SVG Path - Simplified India Outline */}
      <path
